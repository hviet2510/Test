...
local Section = Tab2:AddSection({"Farm"})
  local Section = Tab2:AddSection({"Farm"}), Icon = "rbxassetid://100306458933414"}),
  local Section = Window:AddTab({Title = "Tab Setting Farm", Icon = "rbxassetid://100306458933414"}),
  local Section = Window:AddTab({Title = "Tab Auto Get Melee V2", Icon = "rbxassetid://100306458933414"}),
  local Section = Window:AddTab({Title = "Tab Items Farm", Icon = "rbxassetid://100306458933414"}),
  local Section = Window:AddTab({Title = "Tab Sea Events", Icon = "rbxassetid://100306458933414"}),
  local Section = Window:AddTab({Title = "Tab Mirage + RaceV4", Icon = "rbxassetid://100306458933414"}),
  local Section = Window:AddTab({Title = "Tab Drago Dojo", Icon = "rbxassetid://100306458933414"}),
  local Section = Window:AddTab({Title = "Tab Prehistoric", Icon = "rbxassetid://100306458933414"}),
  local Section = Window:AddTab({Title = "Tab Raid", Icon = "rbxassetid://100306458933414"}),
  local Section = Window:AddTab({Title = "Tab Combat PVP", Icon = "rbxassetid://100306458933414"}),
  local Section = Window:AddTab({Title = "Tab Teleport", Icon = "rbxassetid://100306458933414"}),
  local Section = Window:AddTab({Title = "Tab Fruits", Icon = "rbxassetid://100306458933414"}),
  local Section = Window:AddTab({Title = "Tab Shop", Icon = "rbxassetid://100306458933414"}),
  local Section = Window:AddTab({Title = "Tab Misc", Icon = "rbxassetid://100306458933414"})
}

Tabs.Main:AddButton({
        Title="Link Join Sever Discord",
        Description="discord.gg/vtgWe5V9bd",
        Callback=function()
            setclipboard(tostring("https://discord.gg/vtgWe5V9bd")) 
        end
})
